export default class Authorization {
    constructor(authorizationForm) {
        ...
        this.nickName = this.authorizationForm.querySelector(".registration__nickName");
        this.button = this.authorizationForm.querySelector(".registration__button");
        this.sendNickNameforAuthorization();
    }
    sendNickNameforAuthorization() {
